...
const ViewSection = ({ warehouses, onEdit, onCreate, onDelete }) => {
    ...
    const __ = (key) => {
        return translations[`Warehouses.${key}`] || key;
    };
...
const FormSection = ({ mode, initialData, branches, onBack, onSubmit }) => {
    ...
    const icons = [
        ...
        { icon: 'store', name: __('store') },
        { icon: 'inventory_2', name: __('inventory') },
        { icon: 'local_shipping', name: __('shipping') },
        { icon: 'ac_unit', name: __('cold_storage') },
        { icon: 'pallet', name: __('pallet') },
        { icon: 'factory', name: __('factory') },
        { icon: 'assignment_return', name: __('returns') },
        { icon: 'shelves', name: __('shelves') },
        { icon: 'garage', name: __('garage') }
    ];
            ...
            <div className="content-card">
                <div className="form-container">
                    <div className="form-section-title">
                        {isEdit ? __('edit_warehouse') : __('create_new_warehouse')}
                    </div>

                    <form onSubmit={handleSubmit}>
                        <div className="form-row">
                            <div className="form-group">
                                <label>{__('warehouse_name')} <span style={{ color: 'red' }}>*</span></label>
                                <input
                                    type="text"
                                    name="name"
                                    className="form-control"
                                    defaultValue={initialData?.name}
                                    placeholder={__('warehouse_name')}
                                    required
                                />
                                {errors.name && <div className="error-message">{errors.name}</div>}
                            </div>
                            <div className="form-group">
                                <label>{__('branch')} <span style={{ color: 'red' }}>*</span></label>
                                <select
                                    name="branch_id"
                                    className="form-control"
                                    ...
                                    required
                                >
                                    <option value="" disabled>{__('select_branch')}</option>
                                    {branches.map(branch => (
                        ...
                        <div className="form-row">
                            <div className="form-group">
                                <label>{__('capacity')} <span style={{ color: 'red' }}>*</span></label>
                                <input
                                    type="number"
                                    name="capacity"
                                    className="form-control"
