...
const AdminLayout = ({
  ...
  const menuItems = [
    ...
    },
    {
      ...
      hasSubmenu: true,
      submenuItems: [
        { icon: 'warehouse', label: 'Warehouses', href: getLocalizedRoute('admin.inventory.warehouses.index') },
        { icon: 'straighten', label: 'Item Units', href: getLocalizedRoute('admin.inventory.item-units.index') },
        { icon: 'tune', label: 'Item Attributes', href: getLocalizedRoute('admin.inventory.item-attributes.index') },
        { icon: 'collections_bookmark', label: 'Product Collections', href: getLocalizedRoute('admin.inventory.product-collections.index') },
        { icon: 'category', label: 'Categories', href: getLocalizedRoute('admin.inventory.categories.index') },
