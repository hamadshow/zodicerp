    ...
    return (
        <AdminLayout activeMenu={translations['sidebar.careers'] || 'Career'}>
            ...
            <div className="breadcrumb">
                ...
                <span>/</span>
                <a href="#" onClick={(e) => { e.preventDefault(); closeForm(); }}>{translations['sidebar.recruitment'] || 'Recruitment'}</a>
                <span>/</span>
                <span>{translations['sidebar.careers'] || 'Careers'}</span>
                {showForm && (
                    <>
                        <span>/</span>
                        <span>{currentCareer ? getTranslation('edit_job', 'Edit Job') : getTranslation('add_job', 'Add Job')}</span>
                    </>
                )}
            </div>
