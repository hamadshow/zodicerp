...
const Edit = ({ quotation, suppliers = [], currencies = [], warehouses = [] }) => {
    const { data, setData, put, processing, errors } = useForm({
        ...
        sent_method: quotation.sent_method || '',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('admin.purchases.quotations.update', quotation.id));
    };

    return (
        <AdminLayout activeMenu="Purchase Management">
            <Head title="Edit Purchase Quotation" />
            <div className="p-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                    <h1 className="text-2xl font-bold text-gray-800">Edit Purchase Quotation</h1>
                    <Link
