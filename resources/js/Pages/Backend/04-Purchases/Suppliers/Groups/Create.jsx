...
const Create = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.purchases.supplier-groups.store'));
    };

    return (
        <AdminLayout activeMenu="Suppliers & AP">
            <Head title="Create Supplier Group" />
            <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-bold text-gray-800">Create Supplier Group</h1>
                    <Link
