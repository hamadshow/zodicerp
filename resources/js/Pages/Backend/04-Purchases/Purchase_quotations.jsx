...
export default function PurchaseQuotations({ quotations, vendors, currencies, products, units, paymentTerms, deliveryTerms }) {
    ...
    }, [data.items, data.discount_amount, data.shipping_charges, data.tax_amount]); // Added dependencies
    ...
    const handleEdit = (quotation) => {
        ...
        setData({
            ...
            shipping_charges: toNum(quotation.shipping_charges),
            grand_total: toNum(quotation.grand_total),
    ...
    const handleDelete = (id) => {
        if (confirm('Are you sure you want to delete this quotation?')) {
            destroy(route('admin.purchases.quotations.destroy', { quotation: id }));
        }
    };
    ...
    const handleSubmit = (e) => {
        ...
        if (mode === 'create') {
            ...
            put(route('admin.purchases.quotations.update', { quotation: data.id }), {
                preserveScroll: true,
                onSuccess: () => setMode('list'),
                onError: () => setActiveTab('general'),
            });
    ...
    return (
        <AdminLayout>
            ...
            <div className="purchase-quotations-module">
                <div className="purchase-quotations-module__header">
                ...
                {mode === 'list' ? (
                    <div className="purchase-quotations-module__table-container">
                        <table>
                            <thead>
                                <tr>
                                    <th>Ref #</th>
                            ...
                            <tbody>
                                {quotations.data.map((q) => (
                                    <tr key={q.id}>
                                        ...
                                        <td>{q.grand_total} {q.currency?.code}</td>
                    ...
                    <form onSubmit={handleSubmit} className="purchase-quotations-module__form-container">
                        <div className="purchase-quotations-module__tabs">
                        ...
                        {/* GENERAL TAB */}
                        <div className={`purchase-quotations-module__tab-content ${activeTab === 'general' ? 'active' : ''}`}>
                            <div className="purchase-quotations-module__grid">
                                ...
                                <div className="form-group">
                                    ...
                                    />
                                    {errors.quotation_date && <span className="error-msg">{errors.quotation_date}</span>}
                                </div>
                                <div className="form-group">
                                ...
                                <div className="form-group">
                                    ...
                                    <select value={data.status} onChange={e => setData('status', e.target.value)}>
                                        ...
                                        <option value="vendor_replied">Vendor Replied</option>
                        ...
                        {/* ITEMS TAB */}
                        <div className={`purchase-quotations-module__tab-content ${activeTab === 'items' ? 'active' : ''}`}>
                        ...
                        {/* TERMS TAB */}
                        <div className={`purchase-quotations-module__tab-content ${activeTab === 'terms' ? 'active' : ''}`}>
                             <div className="purchase-quotations-module__grid">
                                <div className="form-group">
                        ...
                        <div className="purchase-quotations-module__actions">
