    ...
    public function run(): void
    {
        $definitions = [
            [
                ...
                'reports' => [
                    ['key' => 'balance-sheet', 'name' => 'Balance Sheet', 'route' => 'admin.financial-reports.balance-sheet'],
                    ['key' => 'balance-sheet-comparison', 'name' => 'Balance Sheet Comparison', 'route' => 'admin.financial-reports.balance-sheet-comparison'],
                    ['key' => 'balance-sheet-detail', 'name' => 'Balance Sheet Detail', 'route' => 'admin.financial-reports.balance-sheet-detail'],
                    ['key' => 'cash-flow', 'name' => 'Cash Flow Statement', 'route' => 'admin.financial-reports.cash-flow'],
                    ['key' => 'profit-loss', 'name' => 'Profit & Loss', 'route' => 'admin.financial-reports.profit-loss'],
                    ['key' => 'profit-loss-comparison', 'name' => 'Profit & Loss Comparison', 'route' => 'admin.financial-reports.profit-loss-comparison'],
                    ['key' => 'profit-loss-class', 'name' => 'Profit & Loss by Class', 'route' => 'admin.financial-reports.profit-loss-class'],
                    ['key' => 'profit-loss-customer', 'name' => 'Profit & Loss by Customer', 'route' => 'admin.financial-reports.profit-loss-customer'],
                    ['key' => 'profit-loss-month', 'name' => 'Profit & Loss by Month', 'route' => 'admin.financial-reports.profit-loss-month'],
                    ['key' => 'profit-loss-detail', 'name' => 'Profit & Loss Detail', 'route' => 'admin.financial-reports.profit-loss-detail'],
                    ['key' => 'equity-change', 'name' => 'Statement of Changes in Equity', 'route' => '#'],
                    ['key' => 'trial-balance', 'name' => 'Trial Balance', 'route' => 'admin.financial-reports.trial-balance'],
            ...
            [
                ...
                'reports' => [
                    ...
                    ['key' => 'general-ledger', 'name' => 'General Ledger', 'route' => 'admin.financial-reports.general-ledger'],
                    ['key' => 'journal', 'name' => 'Journal', 'route' => 'admin.financial-reports.journal'],
